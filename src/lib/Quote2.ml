...
module type S =
sig
  val quote_nf : env -> Val2.nf -> Tm.tm
  val quote_neu : env -> Val2.neu -> Tm.tm Tm.cmd
  val quote_ty : env -> Val2.value -> Tm.tm

  val equiv : env -> ty:Val2.value -> Val2.value -> Val2.value -> unit
  val equiv_ty : env -> Val2.value -> Val2.value -> unit
  val subtype : env -> Val2.value -> Val2.value -> unit
end
