...
\newcommand\TSubstA[3]{
  \TExp{subst_{\Atom{}}}{
    \FmtThin{#1}%
    \mathbin{{\color{gray}\triangleright}}%
    \FmtThin{#2},
    \FmtThin{#3}
  }
}
...
\newcommand\PushSubstA[4]{\Squares*{\FmtThin{#1}\triangleright\FmtThin{#2}}*\FmtTm{#3}\leadsto\FmtTm{#4}}
...
\begin{mathparpagebreakable}
  ...
  \inferrule[QuoteCoeUp]{
    ...
    \\\\
    \Eval{\ThinId}{\ThinId}{\parallel\Gamma\parallel}{
      \TExp{subst}{
        \ThinRep{\ThinId}{
          \TExp{\downarrow}{
            \Interval,
