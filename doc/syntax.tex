...
Path types can be defined in terms of dependent function and extension types as follows:
\[
  \TExp{path}{
    A,
    M,
    ...
    \TExp{ext}{
      ...
      \Squares*{
        \Tube{
          ...
          \ThinTmVar{\ThinSkip{\ThinId}}{M}
        },
        \Tube{
          \TExp{\uparrow}{\Var{0}}
        }{1}{
          \ThinTmVar{\ThinSkip{\ThinId}}{N}
        }
      }
    }
  }
