...
$X$-Thinnings are a defunctionalized representation of renamings which
capture the idea of deleting some variables from within a context, or
possibly replacing them with an element of the family
